...
function addElement() {
    //use const (instead of VAR) to make sure we don't change the value, can use let if you do need to change the value
...
function main() {
    ...
    //add listeners when the page loads
    addListeners();

    //add 100 elements when the page loads
    addElements(100);
}
